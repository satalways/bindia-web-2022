...
@section('content')
    ...
    <div class="bn-shops-banner">
        <img src="{{ asset('asstes/image/shop/lyngby.jpg') }}" data-src="{{ asset('asstes/image/shop/lyngby.jpg') }}" alt="" class="d-sm-block d-none lazy">
        <img src="{{ asset('asstes/image/shop/lyngby-mobile.jpg') }}" data-src="{{ asset('asstes/image/shop/lyngby-mobile.jpg') }}" alt="" class="d-sm-none d-block lazy">
    ...
    <div class="bn-shop-review-box">
        <div class="container">
            ...
            {{--            </div>--}}
            {!! makeGoogleReview(shop('lhg')->rating_link, 190, 4.1) !!}
            <img class="bn-line-width" src="{{ asset('asstes/image/shop/line-line.svg') }}" alt="">
