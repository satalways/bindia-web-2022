...
{{--                        </a>--}}
                        <img src="{{ asset('asstes/image/shop/map-holder.svg') }}" alt="" onclick="window.open('{{ shop('gkv')->google_search }}')" style="cursor: pointer">
                    </div>
            ...
            <div class="row">
                <div class="col-md-9 col-12">
                    <div class="bn-details-content">
                        <h2>Gl. Kongevej</h2>
                        <p>{{ __('gkv.shop_description_1') }}</p>
                        <p>
                            {{ __('gkv.shop_description_2') }}
                        </p>
                    </div>
                </div>
            </div>
