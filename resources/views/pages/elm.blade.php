...
@section('content')
    ...
    <div class="bn-shops-banner">
        ...
        <img src="{{ asset('asstes/image/shop/elmegade-mobile.jpg') }}" data-src="{{ asset('asstes/image/shop/elmegade-mobile.jpg') }}" alt="" class="d-sm-none d-block lazy">
    ...
    <div class="bn-shop-review-box">
        <div class="container">
            <a target="_blank" href="{{ shop('elm')->smily_link }}"><img src="{{ asset('asstes/image/shop/smile.svg') }}" alt=""></a>
            ...
            {{--            </div>--}}
            {!! makeGoogleReview(shop('elm')->rating_link, 79, 4.0) !!}
            <img class="bn-line-width" src="{{ asset('asstes/image/shop/line-line.svg') }}" alt="">
            <div class="bn-text-shop">
                <a href="{{ shop('elm')->inside_link }}" target="_blank">
                    Look inside
                </a>
            </div>
