<?php
return [
    'same_price' => 'Samme pris og kvalitet',
    'text' => '
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
            <div class="bn-menu-b-box">
                <ul class="list-unstyled">
                    <li><a target="_blank" class="" href=":amg_inside_link">:amg_name</a></li>
                    <li><a target="_blank" class="" href=":gkv_inside_link">:gkv_name</a></li>
                    <li><a target="_blank" class="" href=":lhg_inside_link">:lhg_name</a></li>
                    <li><a target="_blank" class="" href=":elm_inside_link">:elm_name</a></li>
                    <li><a target="_blank" class="" href=":shg_inside_link">:shg_name</a></li>
                    <li><a target="_blank" class="" href=":bdv_inside_link">:bdv_name</a></li>
                </ul>
            </div>
        </div>
        <div class="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-12">
